...
for _ in range(100000):
  ...
  #   less_row = [0] * m 
  #   less_row[idx] = 1
  #   b_val = np.random.randint(0, 1000000)
  #   b.append(b_val)
  #   greater_row = [0] * m 
  #   greater_row[idx] = 1
  #   b.append(-np.random.randint(0, 1000000))
  #   A.append(less_row)
  #   A.append(greater_row)
  ...
  proc = subprocess.Popen(['./ad-allocation.sh'], stdin = subprocess.PIPE, stdout = subprocess.PIPE, universal_newlines = True)
  ...
  assert((end-start).microseconds < 6000000)
  print()